...
#define ADD_SELECTABLE_UNIT(UnitType)                                        \
  ...
  ADD_SELECTABLE_UNIT(unit::Shooter);
  ADD_SELECTABLE_UNIT(unit::IceMaker);
  ADD_SELECTABLE_UNIT(unit::Shield);
  ADD_SELECTABLE_UNIT(unit::Explosive);
  ADD_SELECTABLE_UNIT(unit::Vial);
